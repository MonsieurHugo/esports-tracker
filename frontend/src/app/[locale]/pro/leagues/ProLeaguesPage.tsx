...
import LeagueStatsSection from '../stats/sections/LeagueStatsSection'
      ...
      <header className="mb-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <h1 className="text-xl font-bold text-(--text-primary)">Leagues</h1>
            <p className="text-sm text-(--text-muted) mt-1">
              Statistiques par ligue professionnelle
            </p>
          </div>
          <button
            onClick={() => {
