...
import ChampionMetaSection from '../stats/sections/ChampionMetaSection'

export default function ProChampionsPage() {
      ...
      <header className="mb-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <h1 className="text-xl font-bold text-(--text-primary)">Champions</h1>
            <p className="text-sm text-(--text-muted) mt-1">
              Meta et statistiques des champions
            </p>
          </div>
          <button
            onClick={() => {
