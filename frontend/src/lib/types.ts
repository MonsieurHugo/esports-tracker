...
export interface ProRecords {
  playerRecords: {
    ...
    highestXpDiffAt15: ProPlayerRecord[]
    highestGoldDiffEnd: ProPlayerRecord[]
    highestCsDiffEnd: ProPlayerRecord[]
  }
  teamRecords: {
    ...
    mostTeamKills: ProTeamRecord[]
    mostGameKills: ProTeamRecord[]
    fastestFirstTower: ProTeamRecord[]
    fastestFirstDragon: ProTeamRecord[]
    fastestFirstHerald: ProTeamRecord[]
    fastestFirstBaron: ProTeamRecord[]
    mostDragons: ProTeamRecord[]
    mostElderDragons: ProTeamRecord[]
    mostBarons: ProTeamRecord[]
  }
  streakRecords: {
