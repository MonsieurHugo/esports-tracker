...
function TopLpGainers({ entries, isLoading, sortDirection, onSortChange, viewMode }: TopLpGainersProps) {
  const toggleSort = () => {
        ...
        <>
          {entries.map((entry) => (
            ...
            >
              ...
              <span className="font-mono font-semibold text-[10px] sm:text-[11px] w-14 text-right text-(--positive)">
